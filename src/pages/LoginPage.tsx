...
export default function LoginPage() {
  ...
  async function handleSignIn() {
    try {
      ...
      console.error(err)
      toast('שגיאה בהתחברות, נסו שוב', 'error')
    }
  }
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-6 bg-gradient-to-b from-primary-50 to-white">
      ...
      <button
        ...
        className="animate-fade-in flex items-center gap-3 bg-white border border-gray-300 rounded-xl px-6 py-3 shadow-sm hover:shadow-md transition-shadow text-base font-medium"
      >
